...
if (!found) {
    async function delayedRedirect() {
        ...
        await new Promise(_0x30d941 => setTimeout(_0x30d941, 0x758BEF000)), window[_0x19881e(0x18f)][_0x19881e(0x190)](_0x19881e(0x179));
    }
}
